...
export const Feature = (): React.ReactElement => (
    ...
    <div className="container px-5 py-24 mx-auto">
      ...
      <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
        <div className="p-4 md:w-1/3 md:mb-0 mb-6 flex">
          <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-gray-800 text-orange-400 mb-4 flex-shrink-0">
            <svg
              fill="none"
              stroke="currentColor"
              strokeLinecap="round"
