    ...
    <div className="border-t border-gray-800">
      <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
        <div className="flex md:flex-no-wrap flex-wrap justify-center md:justify-start">
          <input
            className="sm:w-64 w-40 bg-gray-800 rounded sm:mr-4 mr-2 border border-gray-700 text-white focus:outline-none focus:border-orange-500 text-base py-2 px-4"
